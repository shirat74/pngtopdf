...
//
const float Resampler::BOX_SUPPORT = 0.5;
float Resampler::box_filter (float t)
{
  return (((t > -0.5) && (t <= 0.5)) ? 1.0 : 0.0);
}

const float Resampler::BILINEAR_SUPPORT = 1.0;
...
const float Resampler::B_SPLINE_SUPPORT = 2.0;
...
const float Resampler::BICUBIC_SUPPORT = 2.0;
#define a -0.5
...
#endif
const float Resampler::LANCZOS3_SUPPORT = 3.0;
...
// Mitchell filter
const float Resampler::MITCHELL_SUPPORT = 2.0;
#define  B  (1.0 / 3.0)
#define  C  (1.0 / 3.0)
...
const struct filterItem Resampler::filters[] = {
  {"Box",       Resampler::box_filter,      Resampler::BOX_SUPPORT},
  {"Bilinear",  Resampler::bilinear_filter, Resampler::BILINEAR_SUPPORT},
  {"B-spline",  Resampler::B_spline_filter, Resampler::B_SPLINE_SUPPORT},
  {"Bicubic",   Resampler::bicubic_filter,  Resampler::BICUBIC_SUPPORT},
  {"Lanczos",   Resampler::Lanczos3_filter, Resampler::LANCZOS3_SUPPORT},
  {"Mitchell",  Resampler::Mitchell_filter, Resampler::MITCHELL_SUPPORT}
};
