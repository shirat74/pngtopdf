...
private:
  ...
  static const float BOX_SUPPORT;
  static const float BILINEAR_SUPPORT;
  static const float B_SPLINE_SUPPORT;
  static const float BICUBIC_SUPPORT;
  static const float LANCZOS3_SUPPORT;
  static const float MITCHELL_SUPPORT;
